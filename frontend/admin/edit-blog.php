						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="http://<?php echo $SERVER_IPADDRESS;?>/admin/edit-blog.php"  class="active"> Edit Blog </a></li>
								</ul>
							</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<!-- Add Blog -->
								<form method="post" enctype="multipart/form-data" autocomplete="off" id="update_service" action="blog.php">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<input class="form-control" type="text" name="service_title" id="service_title" value="Doctae – Making your clinic painless visit?" required="">
												</div>
											</div>
										</div>
									</div>
													...
													<ul class="upload-wrap">
														<li>
															<div class=" upload-images">
																<img alt="Blog Image" src="assets/img/profiles/avatar-17.jpg">
															</div>
														</li>
														<li>
															<div class=" upload-images">
