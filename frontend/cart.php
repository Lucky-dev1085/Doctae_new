											...
											<ul class="booking-total-list text-align">
												<li>
													<div class="clinic-booking pt-4">
														<a class="apt-btn" href="cart.php">View Card</a>
													</div>
												</li>
												<li>
													<div class="clinic-booking pt-4">
														<a class="apt-btn" href="product-checkout.php">Checkout</a>
													</div>
												</li>
											</ul>
										</div>
								...
								<table class="table table-hover table-center mb-0">
									...
									<tbody>
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description.php" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product.jpg" alt="User Image"></a>
												</h2>
												<a href="product-description.php">Benzaxapine Croplex</a>
											</td>
											<td>26565</td>
											<td>$19</td>					
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description.php" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product1.jpg" alt="User Image"></a>
												</h2>
												<a href="product-description.php">Ombinazol Bonibamol</a>
											</td>
											<td>865727</td>
											<td>$22</td>					
											<td class="text-center">
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description.php" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product2.jpg" alt="User Image"></a>
												</h2>
												<a href="product-description.php">Dantotate Dantodazole</a>
											</td>
											<td>978656</td>
											<td>$10</td>					
											<td class="text-center">
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description.php" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product3.jpg" alt="User Image"></a>
												</h2>
												<a href="product-description.php">Alispirox Aerorenone</a>
											</td>
											<td>543252</td>
											<td>$26</td>					
											<td class="text-center">
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description.php" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product4.jpg" alt="User Image"></a>
												</h2>
												<a href="product-description.php">Nitrolozin Zithrotropin</a>
											</td>
											<td>634534</td>
											<td>$12</td>					
											<td class="text-center">
										...
										<div class="booking-item-wrap">
											...
											<div class="booking-total">
												<ul class="booking-total-list">
													...
													<li>
														<div class="clinic-booking pt-4">
															<a class="apt-btn" href="product-checkout.php">Proceed to checkout</a>
														</div>
													</li>
												</ul>
											</div>
