								...
								<ul class="submenu">
									...
									<li class="has-submenu active">
										...
										<ul class="submenu">
											...
											<li class="active"><a href="doctor-add-blog.php">Add Blog</a></li>
										</ul>
									</li>
								</ul>
							</li>	
							...
							<div class="doc-review review-listing custom-edit-service">
								...
								<div class="card">
									<div class="card-body">	
										...
										<form method="post" enctype="multipart/form-data" autocomplete="off" id="update_service" action="doctor-blog.php">
