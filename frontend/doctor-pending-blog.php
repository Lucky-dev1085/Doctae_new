					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="has-submenu active">
										...
										<ul class="submenu">
											<li class="active"><a href="doctor-blog.php">Blog</a></li>
							...
							<li class="has-submenu">
								...
								<ul class="submenu">
									<li><a href="pharmacy-index.php">Pharmacy Home</a></li>
						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Doctor Pending Blog</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">Doctor Pending Blog</h2>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="row mb-5">
                                    <div class="col">
                                        <ul class="nav nav-tabs nav-tabs-solid">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="doctor-pending-blog.php">Pending Blog</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-auto">
                                        <a class="btn btn-primary btn-sm" href="doctor-add-blog.php"><i class="fas fa-plus mr-1"></i> Add Blog</a>
                                    </div>
                                </div>
										...
										<div class="blog grid-blog">
											...
											<div class="blog-content">
												<ul class="entry-meta meta-item">
													<li>
														<div class="post-author">
															<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-05.jpg" alt="Post Author"> <span>Dr. Marvin Campbell</span></a>
														</div>
													</li>
													<li><i class="far fa-clock"></i> 1 Dec 2019</li>
												</ul>
												<h3 class="blog-title"><a href="blog-details.php">Online Doctor Appointment Scheduling</a></h3>
												<p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
											</div>
											<div class="row pt-3">
												<div class="col"><a href="edit-blog.php" class="text-success"><i class="far fa-edit"></i> Edit</a></div>
										...
										<div class="blog grid-blog">
											...
											<div class="blog-content">
												<ul class="entry-meta meta-item">
													<li>
														<div class="post-author">
															<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-06.jpg" alt="Post Author"> <span>Dr. Katharine Berthold</span></a>
														</div>
													</li>
													<li><i class="far fa-clock"></i> 30 Nov 2019</li>
												</ul>
												<h3 class="blog-title"><a href="blog-details.php">Simple steps to make your doctor visits exceptional!</a></h3>
												<p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
											</div>
											<div class="row pt-3">
												<div class="col"><a href="edit-blog.php" class="text-success"><i class="far fa-edit"></i> Edit</a></div>
										...
										<div class="blog grid-blog">
											...
											<div class="blog-content">
												<ul class="entry-meta meta-item">
													<li>
														<div class="post-author">
															<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-07.jpg" alt="Post Author"> <span>Dr. Linda Tobin</span></a>
														</div>
													</li>
													<li><i class="far fa-clock"></i> 28 Nov 2019</li>
												</ul>
												<h3 class="blog-title"><a href="blog-details.php">Choose your own Online Doctor Appointment</a></h3>
												<p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
											</div>
											<div class="row pt-3">
												<div class="col"><a href="edit-blog.php" class="text-success"><i class="far fa-edit"></i> Edit</a></div>
										...
										<div class="blog grid-blog">
											...
											<div class="blog-content">
												<ul class="entry-meta meta-item">
													<li>
														<div class="post-author">
															<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-08.jpg" alt="Post Author"> <span>Dr. Paul Richard </span></a>
														</div>
													</li>
													<li><i class="far fa-clock"></i> 25 Nov 2019</li>
												</ul>
												<h3 class="blog-title"><a href="blog-details.php">Simple steps to visit your doctor today</a></h3>
												<p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
											</div>
											<div class="row pt-3">
												<div class="col"><a href="edit-blog.php" class="text-success"><i class="far fa-edit"></i> Edit</a></div>
										...
										<div class="blog grid-blog">
											...
											<div class="blog-content">
												<ul class="entry-meta meta-item">
													<li>
														<div class="post-author">
															<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-09.jpg" alt="Post Author"> <span>Dr. John Gibbs</span></a>
														</div>
													</li>
										...
										<div class="blog grid-blog">
											...
											<div class="blog-content">
												<ul class="entry-meta meta-item">
													<li>
														<div class="post-author">
															<a href="doctor-profile.php"><img src="assets/img/doctors/doctor-thumb-10.jpg" alt="Post Author"> <span>Dr. Olga Barlow</span></a>
														</div>
													</li>
													<li><i class="far fa-clock"></i> 23 Nov 2019</li>
												</ul>
												<h3 class="blog-title"><a href="blog-details.php">Online Doctoral Programs</a></h3>
												<p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
											</div>
											<div class="row pt-3">
												<div class="col"><a href="edit-blog.php" class="text-success"><i class="far fa-edit"></i> Edit</a></div>
