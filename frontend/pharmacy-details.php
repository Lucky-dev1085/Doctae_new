						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="pharmacy-details.php">Pharmacy Details</a></li>
							...
							<div class="doctor-widget">
								...
								<div class="doc-info-right d-flex align-items-center justify-content-center">
									<div class="clinic-booking">
										<a class="view-pro-btn" href="chat.php">Send Message</a>
										<a class="apt-btn" href="#" data-toggle="modal" data-target="#voice_call">Call Now</a>
										<a href="product-all.php" class="view-pro-btn">Browse Products</a>
									</div>
								</div>
							</div>
