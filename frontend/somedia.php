										...
										<div class="row">
											<div class="col-md-12 col-lg-8">
												<div class="form-group">
													...
													<input type="text" id="facebookurl" class="form-control">
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="col-md-12 col-lg-8">
												<div class="form-group">
													...
													<input type="text "  id="printerestUrl" class="form-control">
												</div>
											</div>
										</div>
										<div class="row">
